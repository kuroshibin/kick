...
const myBot = ['u5a28d8e76adf14a9fe516112963647b0','u5f3881b4dd34a3e0eeac8f9fd10e43f4'];
...
\n";
        ...
        if(txt === 'hooya' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'hooya' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
